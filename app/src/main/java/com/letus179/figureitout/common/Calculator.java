...
public class Calculator {
    ...
    public enum Operator {
        ...
        ADD("+", 10), SUBTRACT("-", 10), MULTIPLY("*", 20), DIVIDE("÷", 20), PARENTHESIS_LEFT(
                "(", 100), PARENTHESIS_RIGHT(")", 100);
                ...
                if (Operator.PARENTHESIS_LEFT.equals(op)) {
                    ...
                    while (true) {
                        if (stack.empty()) {
                            ...
                            return null;
                        } else if (Operator.PARENTHESIS_LEFT.operator
                                .equals(stack.peek())) {
                            stack.pop();
                            break;
                        } else {
    ...
    public String calculate(List<String> exp) {
        List<String> expList = dealExpr(exp);
        if (expList == null) {
            return null;
        }
        Stack<String> stack = new Stack<String>();
