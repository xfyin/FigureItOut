...
public class ModelOneActivity extends AppCompatActivity {
    ...
    private void init() {
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ModelOneActivity.this, MainActivity.class);
        ...
        start_answer_one.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ModelOneActivity.this, ModelOnePlayActivity.class);
